...
let unfundedString = unFunded.length === 1 ? "game" : "games";

// create a new DOM element containing the template string and append it to the description container
let gameDesc = document.createElement("p");
gameDesc.innerHTML = `A total of $${totalRaised.toLocaleString()} has been raised for ${
  GAMES_JSON.length
} games. Currently, ${
  unFunded.length
} ${unfundedString} remain unfunded. We need your help to fund these amazing games!`;
